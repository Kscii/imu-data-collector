# Desktop calibration preview — 0.3.1-rc.1
...
- Windows bootstrap byte-hash consistency and platform-aware macOS BLE scan tests.

[Installation and experiment guide](https://github.com/Kscii/imu-data-collector/blob/desktop-v0.3.1-rc.1/docs/calibration-experiments.md)
